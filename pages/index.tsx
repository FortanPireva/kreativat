...
const IndexPage = () => (
  ...
  >
    <div className="bg-hero text-white bg-no-repeat w-full bg-cover  min-h-screen h-screen  relative z-10 py-6 space-y-16 lg:space-y-24">
      ...
      <form className="relative z-10 mx-4 lg:max-w-xl lg:mx-auto flex justify-center items-center max-w-xl gap-0   ">
        <input
          type="text"
          placeholder="E-maili juaj"
          className=" w-full bg-kreativat-dark-blue text-2xl h-20 font-light text-white placeholder-gray-500 py-5 pl-5 pr-20 lg:pr-52 rounded-sm"
        />
        <button className="absolute uppercase right-3 px-3 py-4 text:lg     md:px-5 md:py-4  md:text-xl font-semibold bg-kreativat-dark-button text-white  transition ease-in-out duration-500 hover:scale-105">
          Më njofto
        </button>
      </form>
    </div>
